...
# Microsoft Agent Framework を使用してマルチエージェント ソリューションを開発する
...
1. リポジトリが開いたら、**[ファイル] > [フォルダーを開く]** を選択し、`mslearn-ai-agents/Labfiles/08-agent-orchestration` に移動して、**[フォルダーの選択]** を選択します。
