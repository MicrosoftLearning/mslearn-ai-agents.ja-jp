...
1. リポジトリが開いたら、**[ファイル] > [フォルダーを開く]** を選択し、`mslearn-ai-agents/Labfiles/09-build-remote-agents-with-a2a` に移動して、**[フォルダーの選択]** を選択します。

1. [エクスプローラー] ペインで、**[Python]** フォルダーを展開して、この演習のコード ファイルを表示します。

1. [エクスプローラー] ビューで **Labfiles/09-build-remote-agents-with-a2a/Python** フォルダーに移動します。ここに、この演習用のスタート コードがあります。
