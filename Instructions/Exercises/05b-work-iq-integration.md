...
9. `.env` ファイルを構成します:
   ...
   > **ヒント:** エンドポイントを取得するには、VS Code で、**[AI Toolkit]** 拡張機能を開き、アクティブなプロジェクトを右クリックし、**[エンドポイントのコピー]** を選択します。
...
> **注:**  このシナリオでは、インデックス付きナレッジ ベースを使用して Foundry プロジェクトで構成された Azure AI 検索 が必要です。
