...
1. 左側のメニューで **[エージェント]** を選択します。

1. 上部のタブの **[エージェント]** ページで、**[ワークフロー]** タブを探して選択します。
...
1. ワークフローのアクション メニューの **[呼び出し]** で、**[エージェント]** を選択して、エージェント ノードを追加します。
...
1. **[ノードの設定]** を選択して、エージェントの入力と出力を構成します。
...
1. **[エージェント]** ノードの下にある **[+]** (プラス) アイコンを選択して、信頼度の低い分類を処理する新しいノードを追加します。
...
1. **[If/Else]** ノードの **[If]** 分岐の下にある **[+]** (プラス) アイコンを選択して、請求チケットを人間のサポートにエスカレートする新しいノードを追加します。
...
1. **[エージェント]** ノード エディターで、**[新しいエージェントの作成]** を選択します。
